...
const EditChannelModal = (props: Props) => {
    ...
    const {channel, channelType: channeltype, server} = data
    ...
    const form = useForm({
      // the reason why we don't use channel values is the modal is rendered before we get the channel values from te store
        defaultValues: {
            name: '',
